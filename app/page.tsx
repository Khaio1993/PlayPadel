  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden">
      ...
      <div className="relative z-20 flex min-h-screen flex-col items-center justify-between px-6 py-12 pb-8">
        ...
        {/* Bouton Sign In avec Google en bas */}
        <div className="w-full max-w-md">
          <button
            onClick={handleSignIn}
            disabled={isSigningIn}
            className="flex w-full items-center justify-center gap-3 rounded-full bg-white px-8 py-4 text-lg font-semibold text-black shadow-xl transition-all duration-200 hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
              <>
